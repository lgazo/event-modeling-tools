 ...
 */
export type EventModelingAddedServices = {
    validation: {
 ...
 */
export type EventModelingServices = LangiumServices & EventModelingAddedServices
 ...
 */
export function createEventModelingServices(context: DefaultSharedModuleContext): {
